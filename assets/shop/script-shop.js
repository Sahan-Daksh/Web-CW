...
function addCartToHTML(){
    ...
    document.querySelector('.cartAmount').textContent = `Total Price: $${totalAmount}`;
...
clearCartBtn.addEventListener('click', () => {
    ...
    cart = [];
    document.querySelector('.cartAmount').textContent = `Total Price: $0`;
    // Clear the cart from the HTML
    addCartToHTML();
